...
(function($) {
	$.formValidator = {
		...
		//读取主题对应的样式           戴瑞  2017  这里以后要改写，高版本jquery没有这个对象
		if($.browser.msie){
		...
		//03如果validator对象对应的element对象的validator属性追加要进行的校验。
		...
		setTipState : function(elem,showclass,showmsg)
	{
		...
		//05把提示层重置成原始提示(如果有defaultPassed,应该设置为onCorrect)
